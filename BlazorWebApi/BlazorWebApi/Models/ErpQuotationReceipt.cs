...
{
    public partial class ErpQuotationReceipt
    {
        public ErpQuotationReceipt()
        {
            ErpContracts = new HashSet<ErpContract>();
            ErpQuotationReceiptAttachments = new HashSet<ErpQuotationReceiptAttachment>();
            ErpQuotationReceiptItems = new HashSet<ErpQuotationReceiptItem>();
            InverseRevisedReceipt = new HashSet<ErpQuotationReceipt>();
        }
        ...
        public short? ValidThru { get; set; }
        ...
        public short? QuotationStatus { get; set; }
        ...
        public virtual ErpQuotationReceipt? RevisedReceipt { get; set; }
        ...
        public virtual ICollection<ErpQuotationReceiptAttachment> ErpQuotationReceiptAttachments { get; set; }
        public virtual ICollection<ErpQuotationReceiptItem> ErpQuotationReceiptItems { get; set; }
        public virtual ICollection<ErpQuotationReceipt> InverseRevisedReceipt { get; set; }
    }
}
