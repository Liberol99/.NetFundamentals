...
{
    public partial class ErpQuotationReceiptItem
    {
        public ErpQuotationReceiptItem()
        {
            ...
            InverseParentItem = new HashSet<ErpQuotationReceiptItem>();
        }
        ...
        public virtual ErpQuotationReceiptItem? ParentItem { get; set; }
        ...
        public virtual ICollection<ErpQuotationReceiptItem> InverseParentItem { get; set; }
    }
}
